...
\begin{stat}
    $Ker(A)=\{0\} \Rightarrow f$ билипшицева, т.е. $\exists C_1,\ C_2 \ \forall x,y: \ C_1||x-y|| < |f(x)-f(y)| < C_2 ||x-y||$
\end{stat}
...
\begin{proof}
    ...
    \textit{Хотим: $y_k=f(x_1, x_2, ..., x_n)$, т.е. выразить каждый игрик через иксы.}\\
\end{proof}
